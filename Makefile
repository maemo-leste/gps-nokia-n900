...
# XXX: FIXME: buffer overflow (see gdb)
FIXME_FLAGS = -D_FORTIFY_SOURCE=0 -fno-stack-protector

GPSNOKIA_CFLAGS = $(CFLAGS)
GPSNOKIA_CPPFLAGS = -D_DEFAULT_SOURCE -D_XOPEN_SOURCE=600 -Wall -pedantic $(CPPFLAGS) $(FIXME_FLAGS)
